...
#include "../include/memory/kmalloc.h" // For kmalloc/krealloc
#include "../include/memory/memory.h"  // For general memory definitions
...
PCI_VENTABLE PciVenTable[] = 
{
	...
	{ 0x1002, "RAGE 3d pro AGP 2x(BGA package)", "ATI Technologies Inc." } ,
	{ 0x1003, "ULSI", "ULSI" } ,
	...
	{ 0x1039, "SiS6205", "Silicon Integrated Systems" } ,
